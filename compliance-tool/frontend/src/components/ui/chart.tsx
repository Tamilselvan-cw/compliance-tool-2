...
/**
 * Props actually passed by Recharts to custom tooltip `content`.
 * We define our own to avoid tight coupling to Tooltip's internal types.
 */
...
const ChartTooltipContent = React.forwardRef<HTMLDivElement, ChartTooltipContentProps>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={cn("font-medium", labelClassName)}>
            {labelFormatter(baseValue, payload as any[])}
          </div>
        );
      }
      ...
      return <div className={cn("font-medium", labelClassName)}>{baseValue}</div>;
